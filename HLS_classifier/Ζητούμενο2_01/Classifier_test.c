...
// svmClassification(x[Dsv],coefficients[Nsv],support_vectors[Nsv][Dsv]);
//  Save the results.
    temp_array[n] = svmClassification_top(x,coefficients,support_vectors);//output;
   ...
   const char* filePath4 = "C:/CSV_VLSI/annotation.csv";
    ...
    //function1(given_value, "C:/CSV_VLSI/annotation.csv", i);
